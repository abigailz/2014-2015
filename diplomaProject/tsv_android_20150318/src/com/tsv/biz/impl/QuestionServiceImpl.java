...
public class QuestionServiceImpl extends AbstrctService implements QuestionService{
	...
	@Override
	public List<Question> list(int pageSize, int size, int state, long time) {
	...
	@Override
	public QuestionEntry get(String qid) {
	...
	@Override
	public String addpic(final String imageFile) {
		String imageType = imageFile.substring(imageFile.lastIndexOf("."));
		final FormFile formFile = new FormFile(System.currentTimeMillis() + imageType
				,new File(imageFile),"FileData","application/octet-stream");
	...
	@Override
	public String dealpic(String imageFile) {
		String imageType = imageFile.substring(imageFile.lastIndexOf("."));
		final FormFile formFile = new FormFile(System.currentTimeMillis() + imageType
				,new File(imageFile),"FileData","application/octet-stream");
	...
	@Override
	public boolean deal(String context) {
	...
	@Override
	public boolean allocate(String qid, String uid, String desc) {
	...
	@Override
	public boolean close(String qid, String loc) {

...
public class PatrolTaskList extends ActionBarActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (str) {
                    case "未处理":
                        intent = new Intent(PatrolTaskList.this, TaskNoComplete.class);
                        startActivity(intent);
                        break;
                    case "未关闭":
                        intent = new Intent(PatrolTaskList.this, PatrolClosedTask.class);
                        startActivity(intent);
                        break;
                    case "已完成":
                        intent = new Intent(PatrolTaskList.this, TaskCompleted.class);
                        startActivity(intent);
                        break;
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.create_task:
                Intent it = new Intent(PatrolTaskList.this, PatrolCreateTask.class);
                startActivity(it);
                break;
            case R.id.back:
                AlertDialog.Builder builder = new AlertDialog.Builder(PatrolTaskList.this);
                ...
                builder.setPositiveButton(R.string.ok,
                        new android.content.DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                arg0.dismiss();
                                Intent it = new Intent(PatrolTaskList.this, LoginActivity.class);
                                startActivity(it);
                            }
                        });

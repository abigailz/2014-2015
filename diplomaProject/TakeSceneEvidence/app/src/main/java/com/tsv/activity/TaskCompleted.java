...
public class TaskCompleted extends ActionBarActivity{
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.back:
                AlertDialog.Builder builder = new AlertDialog.Builder(TaskCompleted.this);
                ...
                builder.setPositiveButton(R.string.ok,
                        new android.content.DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                arg0.dismiss();
                                Intent it = new Intent(TaskCompleted.this, LoginActivity.class);
                                startActivity(it);
                            }
                        });

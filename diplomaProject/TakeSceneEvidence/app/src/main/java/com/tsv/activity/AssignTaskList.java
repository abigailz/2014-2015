...
public class AssignTaskList extends ActionBarActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (str) {
                    case "未处理":
                        intent = new Intent(AssignTaskList.this, AssginTask.class);
                        startActivity(intent);
                        break;
                    case "未关闭":
                        intent = new Intent(AssignTaskList.this, TaskNoClosed.class);
                        startActivity(intent);
                        break;
                    case "已完成":
                        intent = new Intent(AssignTaskList.this, TaskCompleted.class);
                        startActivity(intent);
                        break;
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.back:
                AlertDialog.Builder builder = new AlertDialog.Builder(AssignTaskList.this);
                ...
                builder.setPositiveButton(R.string.ok,
                        new android.content.DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                arg0.dismiss();
                                Intent it = new Intent(AssignTaskList.this, LoginActivity.class);
                                startActivity(it);
                            }
                        });
